...
export default function OrdersPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <p className="mt-2 text-gray-400">Historia Twoich zakupów w SportStore</p>
      ...
      {loading ? (
        ...
        >
          ...
          <p className="mt-4 text-gray-400">Nie masz jeszcze żadnych zamówień.</p>
          <Link
            to="/"
          ...
          {orders.map((order, i) => (
            ...
            >
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  <h2 className="font-semibold text-white">Zamówienie #{order.id}</h2>
                ...
                <div className="text-right">
                  ...
                  >
                    {order.is_paid ? 'Opłacone' : 'Oczekuje na płatność'}
                  </span>
                </div>
              </div>
